...
describe('WordList', () => {
    ...
    it('should return the n closest matches for a word', () => {
        ...
        expect(((_b = (_a = closestMatches[0]) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : 0)).toBe('word2');
        expect(((_d = (_c = closestMatches[1]) === null || _c === void 0 ? void 0 : _c[0]) !== null && _d !== void 0 ? _d : 0)).toBe('word3');
    });
...
//# sourceMappingURL=WordList.test.js.map